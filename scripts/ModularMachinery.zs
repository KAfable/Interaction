...
recipes.addShaped(<modularmachinery:blockcasing>*2, [[rstone,<ore:dyeOrange>,rstone],[<ore:dyeOrange>,<skyresources:casing:12>,<ore:dyeOrange>],[rstone,<ore:dyeOrange>,rstone]]);
